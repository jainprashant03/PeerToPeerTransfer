...
public class MyTestClient {
    ...
    public void go(){
        ...
        try {
            ...
            String lf = "\n";
            String cr = "\r";
            String addCommand = "ADD" + sp + "RFC" + sp + "1234" + sp + "2P-CI/1.0" + cr + lf + "Host:" + sp + "my.host" + cr + lf + "Port:" + sp + "5678" + cr + lf + "Title:" + sp + "A Proferred Official ICP" + cr + lf;            
            System.out.println("printing client message to server "+ addCommand);
            String addCommand1 = "ADD" + sp + "RFC" + sp + "1235" + sp + "2P-CI/1.0" + cr + lf + "Host:" + sp + "my.host" + cr + lf + "Port:" + sp + "5678" + cr + lf + "Title:" + sp + "A Proferred Official ICP" + cr + lf;            
            System.out.println("printing client message to server "+ addCommand1);
            String lookupCommand = "LOOKUP" + sp + "RFC" + sp + "134" + sp + "2P-CI/1.0" + cr + lf + "Host:" + sp + "my.host" + cr + lf + "Port:" + sp + "5678" + cr + lf + "Title:" + sp + "A Proferred Official ICP" + cr + lf;            
            System.out.println("printing client message to server "+ lookupCommand);
            String lookupCommand1 = "LOOKUP" + sp + "RFC" + sp + "1234" + sp + "2P-CI/1.0" + cr + lf + "Host:" + sp + "my.host" + cr + lf + "Port:" + sp + "5678" + cr + lf + "Title:" + sp + "A Proferred Official ICP" + cr + lf;            
            System.out.println("printing client message to server "+ lookupCommand1);
            String listCommand = "LIST" + sp + "ALL" + sp + "2P-CI/1.0" + cr + lf + "Host:" + sp + "my.host" + cr + lf + "Port:" + sp + "5678" + cr + lf;       
            String logoffCommand ="LOGOFF" + sp + "my.host" + cr + lf;
...
//            System.out.println("printing client message to server "+ addCommand);
        MyTestClient client1 = new MyTestClient();
        client1.go();
    }
